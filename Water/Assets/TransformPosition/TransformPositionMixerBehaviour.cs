...
public class TransformPositionMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            ScriptPlayable<TransformPositionBehaviour> inputPlayable = (ScriptPlayable<TransformPositionBehaviour>)playable.GetInput(i);
            TransformPositionBehaviour input = inputPlayable.GetBehaviour ();
